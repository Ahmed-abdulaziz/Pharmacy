    ...
    session_start(); 
        ...
        if(isset($_POST['send'])){
            $email=$_POST['email'];
            $password=$_POST['pass'];
            $stmt=$con->prepare("SELECT  id,username ,email, Password FROM admin WHERE email= ? AND Password = ? AND grouped = 1 ");
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary" name="send">Login</button>
                                            </div>
                                        </form>
                                    </div>
